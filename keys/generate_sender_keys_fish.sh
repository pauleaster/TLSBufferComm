...
echo "set -xg EB_SENDER_CERTIFICATE_DATA '$EB_SENDER_CERTIFICATE_DATA'" >> ~/.config/fish/config.fish
echo "set -xg EB_SENDER_PRIVATE_KEY_DATA '$EB_SENDER_PRIVATE_KEY_DATA'" >> ~/.config/fish/config.fish
